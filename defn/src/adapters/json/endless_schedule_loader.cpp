...
EndlessTuning parse_tuning(const Dictionary &data) {
    ...
    return {
        ...
        .elite_first_wave = VariantTools::as_int(data.get("elite_first_wave", defaults.elite_first_wave)),
        .elite_fraction_growth = VariantTools::as_double(data.get("elite_fraction_growth", defaults.elite_fraction_growth)),
        .elite_fraction_cap = VariantTools::as_double(data.get("elite_fraction_cap", defaults.elite_fraction_cap)),
        .elite_hp = VariantTools::as_double(data.get("elite_hp", defaults.elite_hp)),
        .elite_hp_growth = VariantTools::as_double(data.get("elite_hp_growth", defaults.elite_hp_growth)),
        .elite_hp_cap = VariantTools::as_double(data.get("elite_hp_cap", defaults.elite_hp_cap)),
        .elite_size = VariantTools::as_double(data.get("elite_size", defaults.elite_size)),
        .supply_start = VariantTools::as_double(data.get("supply_start", defaults.supply_start)),
        .supply_growth = VariantTools::as_double(data.get("supply_growth", defaults.supply_growth)),
        .bounty_decay = VariantTools::as_double(data.get("bounty_decay", defaults.bounty_decay)),
        .bounty_decay_curve = VariantTools::as_double(data.get("bounty_decay_curve", defaults.bounty_decay_curve)),
        .bounty_floor = VariantTools::as_double(data.get("bounty_floor", defaults.bounty_floor)),
        ...
        .cleared_field_grace = VariantTools::as_double(data.get("cleared_field_grace", defaults.cleared_field_grace)),

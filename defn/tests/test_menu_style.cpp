...
void check_color_close(const godot::Color &actual, const godot::Color &expected) {
...
Color make_content_color(float red, float green, float blue, float alpha) { return {.r = red, .g = green, .b = blue, .a = alpha}; }

} // namespace

DEFN_TEST(menu_style_parse_color_array_handles_alpha_and_fallback) {
    check_color_close(parse_color_array(make_array({0.1, 0.2, 0.3})), godot::Color(0.1F, 0.2F, 0.3F, 1.0F));
    check_color_close(parse_color_array(make_array({0.4, 0.5, 0.6, 0.7})), godot::Color(0.4F, 0.5F, 0.6F, 0.7F));
    check_color_close(parse_color_array(make_array({0.8, 0.9}), godot::Color(0.2F, 0.3F, 0.4F, 0.5F)), godot::Color(0.2F, 0.3F, 0.4F, 0.5F));
}
...
DEFN_TEST(menu_style_make_style_maps_plain_style_values) {
    ...
    check_color_close(style->get_bg_color(), godot::Color(0.2F, 0.3F, 0.4F, 0.5F));
    check_color_close(style->get_border_color(), godot::Color(0.6F, 0.7F, 0.8F, 0.9F));
...
DEFN_TEST(menu_style_builds_button_style_with_defaults_and_overrides) {
    ...
    check_color_close(button_style.normal_font, godot::Color(0.1F, 0.2F, 0.3F, 0.4F));
    check_color_close(button_style.hover_font, godot::Color(0.5F, 0.6F, 0.7F, 0.8F));
    check_color_close(button_style.pressed_font, godot::Color(0.9F, 0.8F, 0.7F, 0.6F));
}
...
DEFN_TEST(menu_style_builds_options_layout_with_defaults_and_overrides) {
    ...
    check_color_close(layout.section_color, godot::Color(1.0F, 0.1F, 0.2F, 0.3F));
    check_color_close(layout.label_color, godot::Color(0.4F, 0.5F, 0.6F, 0.7F));
    check_color_close(layout.value_color, godot::Color(0.8F, 0.9F, 1.0F, 0.5F));
}
...
DEFN_TEST(menu_style_applies_theme_and_disabled_state_to_button) {
    ...
    button_style.normal_font = godot::Color(0.1F, 0.2F, 0.3F, 0.4F);
    button_style.hover_font = godot::Color(0.5F, 0.6F, 0.7F, 0.8F);
    button_style.pressed_font = godot::Color(0.9F, 0.8F, 0.7F, 0.6F);
    ...
    check_color_close(button->get_theme_color("font_color"), godot::Color(0.1F, 0.2F, 0.3F, 0.4F));
    check_color_close(button->get_theme_color("font_hover_color"), godot::Color(0.5F, 0.6F, 0.7F, 0.8F));
    check_color_close(button->get_theme_color("font_pressed_color"), godot::Color(0.9F, 0.8F, 0.7F, 0.6F));
    ...
    check_color_close(button->get_modulate(), godot::Color(0.5F, 0.5F, 0.5F, 0.7F));

    apply_disabled_style(button, true);
    DEFN_CHECK(!button->is_disabled());
    check_color_close(button->get_modulate(), godot::Color(1.0F, 1.0F, 1.0F, 1.0F));
